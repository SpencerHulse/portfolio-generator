const generatePage = (templateData) => {
  ...
  //the addition of header will create three variables based on data in templateData
  //it takes projects and about, then places the REST in a new header object
